...
#define RUM_KERNEL_STACK_GUARD(slot) (RUM_KERNEL_STACK_BASE + (slot) * RUM_KERNEL_STACK_STRIDE)
#define RUM_KERNEL_STACK_SLOT_BASE(slot) (RUM_KERNEL_STACK_GUARD(slot) + RUM_PAGE_SIZE)
#define RUM_KERNEL_STACK_SLOT_TOP(slot) (RUM_KERNEL_STACK_SLOT_BASE(slot) + RUM_KERNEL_STACK_SIZE)
